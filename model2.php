...
<head>
    ...
    <link rel="stylesheet" href="https://unpkg.com/swiper/swiper-bundle.min.css"> <!--свайпер врубил-->
</head>
<body>
    <header>
    ...
    <main class="product-page">
         <div class="product-gallery">
            <div class="swiper-container">
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <img src="product/boots2.jpg" alt="Nike Mercurial Superfly">
                    </div>
                    <div class="swiper-slide">
                        <img src="product/vapor.jpg" alt="Nike Mercurial Superfly">
                    </div>
                    <div class="swiper-slide">
                        <img src="product/vapor1.jpg" alt="Nike Mercurial Superfly">
                    </div>
                    <div class="swiper-slide">
                        <img src="product/vapor2.jpg" alt="Nike Mercurial Superfly">
                    </div>
                    <div class="swiper-slide">
                        <img src="product/vapor3.jpg" alt="Nike Mercurial Superfly">
                </div>
                </div>
            ...
            <div class="thumbnails">
                <img src="product/vapor.jpg" alt="Nike Vapor Edge Pro 2" onclick="changeImage(0)">
                <img src="product/vapor1.jpg" alt="Nike Vapor Edge Pro 2" onclick="changeImage(1)">
                <img src="product/vapor2.jpg" alt="Nike Vapor Edge Pro 2" onclick="changeImage(2)">
                <img src="product/vapor3.jpg" alt="Nike Vapor Edge Pro 2" onclick="changeImage(3)">
            </div>
        </div>
        <div class="product-info">
            <h1 class="product-title">Nike Vapor Edge Pro 2</h1>
   ...
   <script src="assets/js/model2.js"></script>
</body>
</html>